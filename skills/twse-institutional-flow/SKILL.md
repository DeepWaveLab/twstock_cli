...
```bash
twse fetch stock.mi-qfiis-sort-20 --json
```
...
- [twse-market-overview](../twse-market-overview/SKILL.md) — Includes institutional data as part of daily snapshot
- [twse-stock-lookup](../twse-stock-lookup/SKILL.md) — Individual stock details

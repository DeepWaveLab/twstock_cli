...
```bash
twse fetch stock.mi-margn --json --limit 20 --normalize
```
...
- Check trading calendar: `twse fetch stock.holidayschedule --json`

## See Also

- [twse-market-overview](../twse-market-overview/SKILL.md) — Includes margin data in daily snapshot
- [twse-stock-lookup](../twse-stock-lookup/SKILL.md) — Individual stock data

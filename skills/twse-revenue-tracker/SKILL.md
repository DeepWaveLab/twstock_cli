...
```bash
twse fetch company.t187ap05-l --json --fields "出表日期,資料年月,公司代號,公司名稱,產業別,營業收入-當月營收,營業收入-去年當月營收,營業收入-去年同月增減(%)" --normalize
```
...
```bash
twse fetch company.t187ap05-l --json --code <CODE> --fields "資料年月,公司代號,公司名稱,營業收入-當月營收,營業收入-去年當月營收,營業收入-去年同月增減(%)" --normalize
```
...
- [twse-stock-lookup](../twse-stock-lookup/SKILL.md) — Includes revenue in stock overview
- [twse-dividend-screener](../twse-dividend-screener/SKILL.md) — Revenue supports dividend sustainability
- [twse-company-profile](../twse-company-profile/SKILL.md) — Full financial deep-dive

## Notes

- Revenue data uses Chinese field names. Use `twse schema company.t187ap05-l --json` to verify exact names.
